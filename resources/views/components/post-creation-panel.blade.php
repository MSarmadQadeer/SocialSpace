<div class="position-fixed top-0 bottom-0 start-0 end-0 post-creation-screen hide">
    <div class="position-relative w-100 h-100">
        <div class="position-absolute top-0 bottom-0 start-0 end-0 d-flex justify-content-center overflow-auto">

            <div class="post-creation-panel w-100 m-auto">
                <div>
                    <div class="component-header">
                        <div class="create-post-text">Create post</div>
                        <div class="close-icon close-post-creation-btn">
                    ...
                    <hr>
                    <form action="/create-post" method="POST" name="post-form" enctype="multipart/form-data">
                        @csrf
                        <textarea placeholder="What's on your mind?" name="caption" class="post-text-caption"></textarea>
                        <input type="file" name="image" id="image-file" class="d-none"
                            accept=".jpg, .jpeg, .png">
                        <label class="images-to-post-block" for="image-file">
                        ...
                        <div onClick="document.forms['post-form'].submit();" class="button post-btn">Post</div>
                    </form>
                </div>
            </div>
